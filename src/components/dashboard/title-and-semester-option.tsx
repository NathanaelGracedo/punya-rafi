  ...
  return (
    <section className="flex items-center justify-between text-slate-50">
      ...
      <div
        ...
        className="relative flex cursor-pointer items-center rounded-3xl border-2 px-5 py-3 transition-all duration-300 ease-in-out hover:bg-slate-50 hover:font-bold hover:text-slate-950"
      >
        <h5>{semester[0]}</h5>
